...
kwargs['Dem_gender'] = st.sidebar.selectbox('Pick a gender',  options=['Male','Other/would rather not say','Female'])

kwargs['Dem_edu'] = st.sidebar.selectbox("Pick your education", data['Dem_edu'].unique())

kwargs['Dem_edu_mom'] = st.sidebar.selectbox("Pick your mother's education", data['Dem_edu_mom'].unique())

kwargs['Dem_employment'] = st.sidebar.selectbox("Pick your employment status", data['Dem_edu_mom'].unique())

kwargs['Dem_Expat'] = st.sidebar.selectbox("Are you an expat?", data['Dem_Expat'].unique())

kwargs['Dem_maritalstatus'] = st.sidebar.selectbox("Choose your marital status", data['Dem_maritalstatus'].unique())

kwargs['Dem_riskgroup'] = st.sidebar.selectbox("Are you in a risk group?", data['Dem_riskgroup'].unique())
kwargs['Dem_isolation'] = st.sidebar.selectbox("Are you isolated?", data['Dem_isolation'].unique())
